local Mo = {
  C = {
    transparent = false, -- Change this based on your preference
    filling_pigments = function(palette)
      -- Define what this function should do
      -- For example, you could print or manipulate the palette here
